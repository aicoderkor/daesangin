...
export default function TavernPage({ onToast }: TavernPageProps) {
  ...
  const remaining = useMemo(() => formatSeconds((game.candidatePaused ? game.candidateTimeRemaining : game.candidateRefreshAt - Date.now()) / Math.max(1, game.tavernSpeedMultiplier)), [game.candidatePaused, game.candidateTimeRemaining, game.candidateRefreshAt, game.tavernSpeedMultiplier])
